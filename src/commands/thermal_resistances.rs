...
// The following function validates that the resistance value fits within a u16 before conversion.
// This approach is chosen for simplicity and safety, as it covers the expected input range and
